...
const Watches = () => {
  ...
  return (
    <div style={{ display: "flex", paddingTop: "57px", height: "100%" }}>
      <div
        style={{
          width: "15%",
          height: "100vh",
      ...
      <div style={{ width: "70%" }}>
        <div style={{ display: "flex" }}>
          ...
          <img
            ...
            src="https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/refresh-best-small-watches-40mm-lead-1631124066.jpg?crop=1.00xw:0.892xh;0,0.0523xh&resize=1200:*"
          />
          <div
            style={{
              backgroundColor: "#DBD9CC",
